...
We audit this assumption using a disentanglement dose-response ladder. Three
...
scorers -- three distinct scoring principles that all
converged on the same result. A supervised probe with no access to the
...
actually use. Information can remain decodable while becoming inaccessible
to distance-based reliability estimators.
